...
class LogSearch extends Tags
{
    public function index()
    {
        ...
        $resultCount = $this->params->get('result_count', null) ?? $this->context['total_results'] ?? $this->context['total_items'] ?? 0;
        $pageNum = $this->params->get('page', null) ?? $this->context['current_page'] ?? $this->context['paginate']['current_page'] ?? 1;
